...
class WordListViewModel(
   private val fullWordList: WordListDatabase
    ...
    var valid2Words = WordSection("2 Letter Words", mutableListOf())
    var valid3Words = WordSection("3 Letter Words", mutableListOf())
    var valid4Words = WordSection("4 Letter Words", mutableListOf())
    var valid5Words = WordSection("5 Letter Words", mutableListOf())
    var valid6Words = WordSection("6 Letter Words", mutableListOf())
    var valid7Words = WordSection("7 Letter Words", mutableListOf())
    var valid8Words = WordSection("8 Letter Words", mutableListOf())
    var valid9Words = WordSection("9 Letter Words", mutableListOf())
    var valid10Words = WordSection("10 Letter Words", mutableListOf())
    var valid11Words = WordSection("11 Letter Words", mutableListOf())
    var valid12Words = WordSection("12 Letter Words", mutableListOf())
    var valid13Words = WordSection("13 Letter Words", mutableListOf())
    var valid14Words = WordSection("14 Letter Words", mutableListOf())
    var valid15Words = WordSection("15 Letter Words", mutableListOf())
